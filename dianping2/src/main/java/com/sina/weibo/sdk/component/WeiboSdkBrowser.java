  ...
  implements BrowserRequestCallBack
{
  ...
  private void startShare()
  {
    ...
    if (localShareRequestParam.hasImage())
    {
      ...
      new AsyncWeiboRunner(this).requestAsync("http://service.weibo.com/share/mobilesdk_uppic.php", localWeiboParameters, "POST", new RequestListener(localShareRequestParam)
      {
        public void onComplete(String paramString)
        {
          LogUtil.d(WeiboSdkBrowser.TAG, "post onComplete : " + paramString);
          ...
          {
            WeiboSdkBrowser.this.openUrl(this.val$req.buildUrl(paramString.getPicId()));
            return;
          }
        ...
        {
          LogUtil.d(WeiboSdkBrowser.TAG, "post onWeiboException " + paramWeiboException.getMessage());
          this.val$req.sendSdkErrorResponse(WeiboSdkBrowser.this, paramWeiboException.getMessage());
          WeiboSdkBrowser.this.finish();
        }
      });
      return;
