...
public class ShareRequestParam extends BrowserRequestParamBase
{
  ...
  private void handleMblogPic(String paramString, byte[] paramArrayOfByte)
  {
    ...
    //   10: dup
    //   11: aload_1
    //   12: invokespecial 94	java/io/File:<init>	(Ljava/lang/String;)V
    //   15: astore_1
    //   16: aload_1
    //   17: invokevirtual 98	java/io/File:exists	()Z
    //   20: ifeq +79 -> 99
    //   23: aload_1
    //   24: invokevirtual 101	java/io/File:canRead	()Z
    //   27: ifeq +72 -> 99
    //   30: aload_1
    ...
    //   36: ifle +63 -> 99
    //   39: aload_1
    //   40: invokevirtual 105	java/io/File:length	()J
    //   43: l2i
    //   44: newarray byte
    //   46: astore 5
    //   48: aconst_null
    ...
    //   50: aconst_null
    //   51: astore 4
    //   53: new 107	java/io/FileInputStream
    //   56: dup
    //   57: aload_1
    ...
    //   62: aload_1
    //   63: aload 5
    //   65: invokevirtual 114	java/io/FileInputStream:read	([B)I
    //   68: pop
    //   69: aload_0
    //   70: aload 5
    //   72: invokestatic 120	com/sina/weibo/sdk/utils/Base64:encodebyte	([B)[B
    //   75: putfield 122	com/sina/weibo/sdk/component/ShareRequestParam:mBase64ImgData	[B
    //   78: aload_1
    //   79: ifnull +7 -> 86
    //   82: aload_1
    //   83: invokevirtual 126	java/io/FileInputStream:close	()V
    //   86: return
    //   87: astore_1
    //   88: aload 4
    //   90: astore_1
    ...
    //   92: ifnull +7 -> 99
    //   95: aload_1
    //   96: invokevirtual 126	java/io/FileInputStream:close	()V
    //   99: aload_2
    //   100: ifnull -14 -> 86
    //   103: aload_2
    //   104: arraylength
    ...
    //   108: aload_0
    //   109: aload_2
    //   110: invokestatic 120	com/sina/weibo/sdk/utils/Base64:encodebyte	([B)[B
    //   113: putfield 122	com/sina/weibo/sdk/component/ShareRequestParam:mBase64ImgData	[B
    //   116: return
    //   117: astore_1
    //   118: aload_3
    //   119: ifnull +7 -> 126
    //   122: aload_3
    //   123: invokevirtual 126	java/io/FileInputStream:close	()V
    //   126: aload_1
    //   127: athrow
    //   128: astore_1
    //   129: goto -30 -> 99
  ...
  private void sendSdkResponse(Activity paramActivity, int paramInt, String paramString)
  {
    ...
    catch (android.content.ActivityNotFoundException paramActivity)
    {
    }
  }
