...
public final class JceInputStream
{
  ...
  private <T> T[] readArrayImpl(T paramT, int paramInt, boolean paramBoolean)
  {
    if (skipToTag(paramInt))
    {
      ...
      Object[] arrayOfObject = (Object[])(Object[])Array.newInstance(paramT.getClass(), i);
      paramInt = 0;
      while (true)
      {
  ...
  public String read(String paramString, int paramInt, boolean paramBoolean)
  {
    ...
    do
    {
      try
      {
        paramString = new String(localObject, this.sServerEncoding);
        return paramString;
      }
  ...
  {
    paramBoolean1 = false;
    if (read(0, paramInt, paramBoolean2) != 0)
      paramBoolean1 = true;
  ...
  public byte[] read(byte[] paramArrayOfByte, int paramInt, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      while (true)
      {
        paramArrayOfByte = (B)localObject;
        if (paramInt >= i)
          break;
  ...
  public String readString(int paramInt, boolean paramBoolean)
  {
    ...
    do
    {
      try
      {
        localObject1 = new String(localObject2, this.sServerEncoding);
        return localObject1;
      }
