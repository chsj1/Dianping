...
public class UniPacket extends UniAttribute
{
  ...
  public byte[] createOldRespEncode()
  {
    ...
    localJceOutputStream.write(localObject, 6);
    localJceOutputStream.write(this._package.status, 7);
    return (B)JceUtil.getJceBufArray(localJceOutputStream.getByteBuffer());
  }
  ...
  public byte[] encode()
  {
    ...
    while (true)
    {
      ...
      localByteBuffer.putInt(i + 4).put(localObject).flip();
