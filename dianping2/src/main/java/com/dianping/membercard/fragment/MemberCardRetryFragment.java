...
public class MemberCardRetryFragment extends CardFragment
{
  ...
  {
    this.containerView = paramLayoutInflater.inflate(R.layout.mc_member_card_retry_layout, paramViewGroup, false);
  ...
  class Adapter extends BasicAdapter
  {
    ...
    public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
    {
      ...
      return getFailedView(this.errorMsg, MemberCardRetryFragment.this.retryListener, paramViewGroup, paramView);
    }
 ...
 * Qualified Name:     com.dianping.membercard.fragment.MemberCardRetryFragment
