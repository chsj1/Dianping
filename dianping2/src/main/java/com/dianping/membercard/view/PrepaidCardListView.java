...
public class PrepaidCardListView extends NovaFrameLayout
  implements AdapterView.OnItemClickListener, View.OnClickListener
{
  ...
  public PrepaidCardListView(Context paramContext)
  {
    this(paramContext, null);
  }

  public PrepaidCardListView(Context paramContext, AttributeSet paramAttributeSet)
  {
  ...
  {
    LayoutInflater.from(getContext()).inflate(R.layout.prepaid_card_list, this, true);
    this.mListView = ((PullToRefreshListView)findViewById(R.id.list));
    this.mListView.setOnItemClickListener(this);
    this.mMockView = findViewById(R.id.mock_item);
    this.mCardInfo = ((PrepaidCardItem)findViewById(R.id.img_u));
  ...
  public void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    label237: for (localObject1 = (DPObject)localObject1; ; localObject1 = null)
    {
      ...
      closeList(true, new Animator.AnimatorListener(paramAdapterView, paramView, paramInt, paramLong)
      {
        ...
        public void onAnimationEnd(Animator paramAnimator)
        {
          if (PrepaidCardListView.this.mOnItemClickWithAnimListener != null)
            PrepaidCardListView.this.mOnItemClickWithAnimListener.onItemClickAfterAnim(this.val$parent, this.val$view, this.val$position, this.val$id);
          PrepaidCardListView.this.mMockView.setVisibility(8);
          PrepaidCardListView.this.mRealView.setVisibility(0);
          if (PrepaidCardListView.this.mNextRealView != null)
            PrepaidCardListView.this.mNextRealView.setVisibility(0);
  ...
  public void showCardInfo(int paramInt)
  {
    new Handler().postDelayed(new Runnable(paramInt)
    {
      public void run()
      {
        PrepaidCardListView.this.onItemClick(PrepaidCardListView.this.mListView, PrepaidCardListView.this.mListView.getChildAt(this.val$postion), this.val$postion, 0L);
      }
    }
    , 100L);
  }
 ...
 * Qualified Name:     com.dianping.membercard.view.PrepaidCardListView
