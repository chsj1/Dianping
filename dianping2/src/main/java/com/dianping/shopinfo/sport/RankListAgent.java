...
public class RankListAgent extends ShopCellAgent
  implements RequestHandler<MApiRequest, MApiResponse>
{
  ...
  private View.OnClickListener mclickListener = new View.OnClickListener()
  {
    public void onClick(View paramView)
    {
      ...
      RankListAgent.this.startActivity(paramView);
    }
  };

  public RankListAgent(Object paramObject)
  {
    super(paramObject);
  }
  ...
  public void onRequestFinish(MApiRequest paramMApiRequest, MApiResponse paramMApiResponse)
  {
    ...
    do
    {
      ...
      this.mRankInfo = ((DPObject)paramMApiResponse.result());
    }
    while (this.mRankInfo == null);
    dispatchAgentChanged(false);
  }

  protected void sendRequest()
  {
    this.mRequest = BasicMApiRequest.mapiGet(Uri.parse("http://m.api.dianping.com/fitness/loadfitnessshopleaderboard.bin").buildUpon().appendQueryParameter("shopid", Integer.toString(shopId())).toString(), CacheType.DISABLED);
  ...
  protected void setupView()
  {
    ...
    {
      return;
      str = this.mRankInfo.getString("Title");
    }
    ...
    localCommonCell.setLeftIconUrl(this.mRankInfo.getString("IconUrl"));
    String str = this.mRankInfo.getString("SubTitle");
    if (!TextUtils.isEmpty(str))
      localCommonCell.setSubTitle(str);
    str = this.mRankInfo.getString("ActionUrl");
    localCommonCell.setClickable(true);
    localCommonCell.setTag(str);
    localCommonCell.setOnClickListener(this.mclickListener);
    localCommonCell.setGAString("fitness_bangdan");
    localCommonCell.gaUserInfo.shop_id = Integer.valueOf(shopId());
    ((DPActivity)getFragment().getActivity()).addGAView(localCommonCell, -1);
    this.mRankListView.addView(localCommonCell);
    addCell("0515ranklist.", this.mRankListView, 64);
  }
}

/* Location:           C:\Users\xuetong\Desktop\dazhongdianping7.9.6\ProjectSrc\classes-dex2jar.jar
 * Qualified Name:     com.dianping.shopinfo.sport.RankListAgent
