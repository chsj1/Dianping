  ...
  implements RequestHandler
{
  ...
  private boolean isBookingShow = false;
  ...
  public void handleMessage(AgentMessage paramAgentMessage)
  {
    ...
    if (paramAgentMessage.what.equals("com.dianping.shopinfo.hotel.BaseScenicTicketAgent.SCENIC_COMMON_TICKET_BOOK_SHOW"))
      onAgentChanged(null);
  }
  ...
  public void onAgentChanged(Bundle paramBundle)
  {
    ...
    while ((!this.isBookingShow) || (this.hasRequested));
    removeAllCells();
    sendRequset();
  }
  ...
  public void onRequestFinish(Request paramRequest, Response paramResponse)
  {
    if (paramRequest == this.request)
    {
      ...
      if (this.shopTicket != null)
      {
        ...
        if ((this.isShow) && (this.ticketGroup != null) && (this.ticketGroup.length > 0))
          setupView();
      }
      this.hasRequested = true;
  ...
  void setupView()
  {
    ...
    View localView = LayoutInflater.from(getContext()).inflate(R.layout.shopinfo_scenic_header, null);
    this.linearLayout.addView(localView);
    localView = LayoutInflater.from(getContext()).inflate(R.layout.shopinfo_line, null);
    localView.setPadding(ViewUtils.dip2px(getContext(), 15.0F), 0, 0, 0);
    this.linearLayout.addView(localView);
    boolean bool1 = false;
    int i = 0;
 ...
 * Qualified Name:     com.dianping.shopinfo.hotel.senic.ScenicBookingAgent
