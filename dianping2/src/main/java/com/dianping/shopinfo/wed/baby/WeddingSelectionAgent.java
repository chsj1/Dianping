...
public class WeddingSelectionAgent extends ShopCellAgent
  implements View.OnClickListener, RequestHandler<MApiRequest, MApiResponse>
{
  final String CELL_ID = "0291Wedding.27Selection";
  DPObject[] objects;
  DPObject packageObject;
  MApiRequest packageRequest;
  int picHeight;
  int picWidth;
  int productCategoryId;

  public WeddingSelectionAgent(Object paramObject)
  {
    super(paramObject);
  ...
  private void initViews()
  {
    ...
    ((NovaRelativeLayout)localObject1).setGAString("packageinfo_more");
    ...
    if (!TextUtils.isEmpty((CharSequence)localObject2))
    {
      ...
      localObject4 = (TextView)localNovaRelativeLayout.findViewById(R.id.textview_wed_selection_price);
      TextView localTextView2 = (TextView)localNovaRelativeLayout.findViewById(R.id.textview_wed_selection_originprice_symbol);
      ...
      ((TextView)localObject4).setText("￥" + j);
    ...
    while (true)
    {
      ...
      localNovaRelativeLayout.setGAString("packageinfo_detail", (GAUserInfo)localObject1);
      ...
      break;
      label801: ((TextView)localObject2).setVisibility(0);
      ((TextView)localObject2).setText((CharSequence)localObject5);
      break label542;
      label815: ((TextView)localObject3).setVisibility(8);
      break label609;
      label825: localTextView1.setVisibility(0);
      ...
      while (j < localObject3.length)
      {
        ...
        if (j != localObject3.length - 1)
          localObject1 = (String)localObject2 + "<font color='#CCCCCC'>  |  </font>";
        j += 1;
      }
      localTextView1.setText(Html.fromHtml((String)localObject1));
    }
    label988: addCell("0291Wedding.27Selection", localView);
  }
  ...
  private void sendSelectionRequest()
  {
    ...
    do
      return;
    while (shopId() <= 0);
    Uri.Builder localBuilder = Uri.parse("http://m.api.dianping.com/wedding/shoppackagerecommend.bin").buildUpon();
    localBuilder.appendQueryParameter("shopid", shopId() + "");
    this.packageRequest = mapiGet(this, localBuilder.toString(), CacheType.NORMAL);
  ...
  {
    if (paramMApiRequest == this.packageRequest)
 ...
 * Qualified Name:     com.dianping.shopinfo.wed.baby.WeddingSelectionAgent
