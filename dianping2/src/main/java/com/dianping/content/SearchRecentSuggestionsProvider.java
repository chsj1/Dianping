...
public class SearchRecentSuggestionsProvider extends ContentProvider
{
  ...
  public Cursor query(Uri paramUri, String[] paramArrayOfString1, String paramString1, String[] paramArrayOfString2, String paramString2)
  {
    ...
    paramArrayOfString1 = localSQLiteDatabase.query(str, localObject1, paramArrayOfString1.toString(), paramArrayOfString2, null, null, paramString2, null);
    paramArrayOfString1.setNotificationUri(getContext().getContentResolver(), paramUri);
    return (Cursor)paramArrayOfString1;
  }

  protected void setupSuggestions(String paramString1, int paramInt, String paramString2)
  {
    if ((TextUtils.isEmpty(paramString1)) || ((paramInt & 0x1) == 0))
      throw new IllegalArgumentException();
    if ((paramString2 != null) && (paramString2.length() > 0))
      sDatabaseName = paramString2;
    if ((paramInt & 0x2) != 0);
    for (boolean bool = true; ; bool = false)
    {
      this.mTwoLineDisplay = bool;
      this.mAuthority = new String(paramString1);
      this.mMode = paramInt;
      ...
      this.mSuggestionProjection = new String[] { "0 AS suggest_format", "display1 AS suggest_text_1", "display2 AS suggest_text_2", "query AS suggest_intent_query", "_id" };
      return;
    }
    this.mSuggestSuggestionClause = "display1 LIKE ?";
    this.mSuggestionProjection = new String[] { "0 AS suggest_format", "display1 AS suggest_text_1", "query AS suggest_intent_query", "_id" };
  }
  ...
  private static class DatabaseHelper extends SQLiteOpenHelper
  {
    ...
    {
      super(SearchRecentSuggestionsProvider.sDatabaseName, null, paramInt);
 ...
 * Qualified Name:     com.dianping.content.SearchRecentSuggestionsProvider
