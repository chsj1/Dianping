  ...
  implements View.OnClickListener
{
  ...
  Handler handler = new Handler()
  {
    public void handleMessage(Message paramMessage)
    {
      if (paramMessage.what != 1)
        return;
      if ((CustomGridView.this.adapter == null) || (CustomGridView.this.adapter.isEmpty()))
      {
        CustomGridView.this.removeAllViews();
        return;
      }
      CustomGridView.this.removeAllViews();
      int i = 0;
      while (true)
      {
        try
        {
          if (i >= CustomGridView.this.adapter.getCount())
            break;
          paramMessage = CustomGridView.this.adapter.getView(i, null, CustomGridView.this);
          if (!(paramMessage instanceof TableRow))
            continue;
          ((TableRow)paramMessage).setBaselineAligned(false);
          CustomGridView.this.addView(paramMessage);
          CustomGridView.this.curRow = ((TableRow)paramMessage);
          break label153;
          if ((paramMessage != null) && (CustomGridView.this.curRow != null))
            CustomGridView.this.curRow.addView(paramMessage);
        }
  ...
  private final DataSetObserver observer = new DataSetObserver()
  {
    ...
    {
      CustomGridView.this.handler.removeMessages(1);
      CustomGridView.this.handler.sendEmptyMessageDelayed(1, 100L);
    }
  ...
  {
    public abstract void onItemClick(CustomGridView paramCustomGridView, View paramView, int paramInt, long paramLong);
  }
}

/* Location:           C:\Users\xuetong\Desktop\dazhongdianping7.9.6\ProjectSrc\classes-dex2jar.jar
 * Qualified Name:     com.dianping.base.widget.CustomGridView
