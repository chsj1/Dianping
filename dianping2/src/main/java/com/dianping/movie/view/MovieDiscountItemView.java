...
public class MovieDiscountItemView extends NovaLinearLayout
  implements View.OnClickListener
{
  ...
  public MovieDiscountItemView(Context paramContext)
  {
    this(paramContext, null);
  }

  public MovieDiscountItemView(Context paramContext, AttributeSet paramAttributeSet)
  {
  ...
  private Dialog buildDialog()
  {
    if (this.popup == null)
    {
      ...
      this.popup.setContentView(R.layout.movie_info_discount_popup);
 ...
 * Qualified Name:     com.dianping.movie.view.MovieDiscountItemView
