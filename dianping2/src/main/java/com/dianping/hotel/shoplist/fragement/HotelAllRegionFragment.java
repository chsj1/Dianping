...
public class HotelAllRegionFragment extends Fragment
  implements TableView.OnItemClickListener, ExpandAnimation.OnExpendActionListener, ExpandAnimation.OnExpendAnimationListener
{
  ...
  private String formatChildrenText(ArrayList<DPObject> paramArrayList, int paramInt)
  {
  ...
  public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, Bundle paramBundle)
  {
    ...
    setData(null);
    this.listView = ((TableView)paramLayoutInflater.findViewById(R.id.region_list));
  ...
  {
    ScrollView localScrollView = (ScrollView)getActivity().findViewById(R.id.focused);
  ...
  public void setData(DPObject[] paramArrayOfDPObject)
  {
    if ((paramArrayOfDPObject != null) && (paramArrayOfDPObject.length > 0))
      this.regionList = paramArrayOfDPObject;
    if (this.regionList != null)
    {
      this.parentCategory.clear();
      this.childCategory.clear();
      paramArrayOfDPObject = this.regionList;
  ...
  private class CategoryAdapter extends BasicAdapter
  {
    ...
    public int getCount()
    {
      return HotelAllRegionFragment.this.parentCategory.size();
    }

    public DPObject getItem(int paramInt)
    {
      return (DPObject)HotelAllRegionFragment.this.parentCategory.get(paramInt);
    }

    public long getItemId(int paramInt)
    {
      return ((DPObject)HotelAllRegionFragment.this.parentCategory.get(paramInt)).getInt("ID");
    }
    ...
    public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
    {
      ...
      if (paramView == null)
        paramViewGroup = LayoutInflater.from(HotelAllRegionFragment.this.getActivity()).inflate(R.layout.more_regionmetro_item, null);
      ...
      Object localObject3 = HotelAllRegionFragment.this.findChildrenRegionWithLimit(((DPObject)localObject1).getInt("ID"), 3);
      paramView = (CustomGridView)paramViewGroup.findViewById(R.id.category_grid);
      ArrayList localArrayList = HotelAllRegionFragment.this.findChildrenRegionWithLimit(((DPObject)localObject1).getInt("ID"), 2147483647);
      localObject3 = HotelAllRegionFragment.this.formatChildrenText((ArrayList)localObject3, localArrayList.size());
      ...
      while (true)
      {
        ...
        localObject1 = new HotelAllRegionFragment.SubCategoryAdapter(HotelAllRegionFragment.this, localArrayList);
        ...
        paramView.setOnItemClickListener(new CustomGridView.OnItemClickListener()
        {
          ...
          {
            paramCustomGridView = (DPObject)((HotelAllRegionFragment.SubCategoryAdapter)paramCustomGridView.getAdapter()).subCategory.get(paramInt);
            paramView = new Intent();
            paramView.putExtra("result", paramCustomGridView);
            paramView.putExtra("type", 2);
            HotelAllRegionFragment.this.getActivity().setResult(-1, paramView);
        ...
        paramInt = (int)Math.ceil(((HotelAllRegionFragment.SubCategoryAdapter)localObject1).getCount() / 3.0D);
        ((LinearLayout.LayoutParams)localObject2).bottomMargin = (-(ViewUtils.dip2px(HotelAllRegionFragment.this.getActivity(), 42.0F) * paramInt + paramInt));
  ...
  private class SubCategoryAdapter extends BasicAdapter
  {
    ...
    public ArrayList<DPObject> subCategory;
    ...
    public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
    {
      ...
      while (true)
      {
        if (paramInt == getCount() - 1)
        {
          ...
          ((TableRow.LayoutParams)localObject).span = ((this.columnCount - getCount() % this.columnCount) % this.columnCount + 1);
 ...
 * Qualified Name:     com.dianping.hotel.shoplist.fragement.HotelAllRegionFragment
