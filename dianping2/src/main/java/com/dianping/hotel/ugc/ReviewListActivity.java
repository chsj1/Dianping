  ...
  implements ReviewShop, RequestHandler<MApiRequest, MApiResponse>
{
  ...
  {
    setContentView(R.layout.hotel_temp_ugc_reviewlist_layout);
        ...
        if (this.enableSearch)
          getTitleBar().addRightViewItem("search", R.drawable.navibar_icon_search, new View.OnClickListener()
          {
            public void onClick(View paramView)
            {
              ...
              ReviewSearchFragment.newInstance(ReviewListActivity.this).setOnSearchFragmentListener(new AbstractSearchFragment.OnSearchFragmentListener()
              {
                ...
                public void startSearch(DPObject paramDPObject)
                {
                  ...
                  {
                    paramDPObject = new Intent("android.intent.action.VIEW", Uri.parse((String)localObject));
                    ReviewListActivity.this.startActivity(paramDPObject);
                    return;
                  }
                  localObject = new Intent("android.intent.action.VIEW", Uri.parse("dianping://reviewsearch?shopid=" + ReviewListActivity.this.mShopId));
                  ((Intent)localObject).putExtra("keyword", paramDPObject.getString("Keyword"));
                  ReviewListActivity.this.startActivity((Intent)localObject);
                }
              });
            }
          });
  ...
  private void processParams(Bundle paramBundle)
  {
    ...
    while (true)
    {
      ...
      catch (NumberFormatException localNumberFormatException)
      {
        ...
        label318: this.mTabIndex = paramBundle.getInt("tabindex");
  ...
  {
    if (this.mListView.hideCommentView())
      return;
    super.onBackPressed();
  }
 ...
 * Qualified Name:     com.dianping.hotel.ugc.ReviewListActivity
