...
public class HomeDesignProductListActivity extends NovaActivity
  implements View.OnClickListener, LoginResultListener, RequestHandler<MApiRequest, MApiResponse>, ShopPhotoGalleryFragment.PhotoGalleryShop
{
  ...
  private void changeTab()
  {
    if (this.mCurTab == 0)
    {
      ...
      setupShopPhotoView();
      localGAUserInfo = getCloneUserInfo();
      localGAUserInfo.shop_id = Integer.valueOf(this.shop.getInt("ID"));
      GAHelper.instance().contextStatisticsEvent(this, "memalbumtab_cagegory", localGAUserInfo, "tap");
      return;
    }
    ...
    localGAUserInfo.shop_id = Integer.valueOf(this.shop.getInt("ID"));
    GAHelper.instance().contextStatisticsEvent(this, "memalbumtab_setting", localGAUserInfo, "tap");
  }
  ...
  private void setTitleBar()
  {
    ...
    while (true)
    {
      ...
      this.titleTab.setTabChangeListener(new ShopListTabView.TabChangeListener()
      {
        ...
        {
          if (HomeDesignProductListActivity.this.mCurTab == paramInt)
            return;
          HomeDesignProductListActivity.access$002(HomeDesignProductListActivity.this, paramInt);
  ...
  private void setupShopPhotoView()
  {
    ...
    localBundle.putInt("photoType", 3);
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    if (paramBundle != null)
    {
      paramBundle = paramBundle.getQueryParameter("id");
 ...
 * Qualified Name:     com.dianping.wed.home.activity.HomeDesignProductListActivity
