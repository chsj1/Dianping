...
import com.dianping.wed.configure.DefaultTextDetailConfigure;
...
public class WeddingProductTextDetailFragment extends WeddingProductBaseFragment
  implements PullToRefreshBase.OnRefreshListener
{
  ...
  protected ArrayList<AgentListConfig> generaterDefaultConfigAgentList()
  {
    ...
    localArrayList.add(new DefaultTextDetailConfigure(this.dpShop));
  ...
  {
    super.resolveArguments(paramBundle);
    this.dpProduct = getObjectParam("product");
  }
}

/* Location:           C:\Users\xuetong\Desktop\dazhongdianping7.9.6\ProjectSrc\classes-dex2jar.jar
 * Qualified Name:     com.dianping.wed.baby.fragment.WeddingProductTextDetailFragment
