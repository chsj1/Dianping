...
public class NovaRelativeLayout extends RelativeLayout
{
  public GAUserInfo gaUserInfo = new GAUserInfo();
  private String mGAElementString = null;
  private View.OnClickListener mListener;

  public NovaRelativeLayout(Context paramContext)
  {
    super(paramContext);
  }

  public NovaRelativeLayout(Context paramContext, AttributeSet paramAttributeSet)
  {
    super(paramContext, paramAttributeSet);
  }

  @SuppressLint({"NewApi"})
  public NovaRelativeLayout(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
 ...
 * Qualified Name:     com.dianping.widget.view.NovaRelativeLayout
