...
public class NovaCheckBox extends CheckBox
{
  public GAUserInfo gaUserInfo = new GAUserInfo();
  private String mGAElementString = null;
  private View.OnClickListener mListener;

  public NovaCheckBox(Context paramContext)
  {
    super(paramContext);
  }

  public NovaCheckBox(Context paramContext, AttributeSet paramAttributeSet)
  {
    super(paramContext, paramAttributeSet);
  }

  public NovaCheckBox(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
 ...
 * Qualified Name:     com.dianping.widget.view.NovaCheckBox
