...
public class NovaLinearLayout extends LinearLayout
{
  ...
  public NovaLinearLayout(Context paramContext)
  {
    super(paramContext);
  }

  public NovaLinearLayout(Context paramContext, AttributeSet paramAttributeSet)
  {
    super(paramContext, paramAttributeSet);
  }

  @SuppressLint({"NewApi"})
  public NovaLinearLayout(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
 ...
 * Qualified Name:     com.dianping.widget.view.NovaLinearLayout
