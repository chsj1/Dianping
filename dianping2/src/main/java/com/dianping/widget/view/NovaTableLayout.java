...
public class NovaTableLayout extends TableLayout
{
  public GAUserInfo gaUserInfo = new GAUserInfo();
  private String mGAElementString = null;
  private View.OnClickListener mListener;

  public NovaTableLayout(Context paramContext)
  {
    super(paramContext);
  }

  public NovaTableLayout(Context paramContext, AttributeSet paramAttributeSet)
  {
 ...
 * Qualified Name:     com.dianping.widget.view.NovaTableLayout
