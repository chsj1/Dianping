...
public class NovaFrameLayout extends FrameLayout
{
  public GAUserInfo gaUserInfo = new GAUserInfo();
  private String mGAElementString = null;
  private View.OnClickListener mListener;

  public NovaFrameLayout(Context paramContext)
  {
    super(paramContext);
  }

  public NovaFrameLayout(Context paramContext, AttributeSet paramAttributeSet)
  {
    super(paramContext, paramAttributeSet);
  }

  @SuppressLint({"NewApi"})
  public NovaFrameLayout(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
 ...
 * Qualified Name:     com.dianping.widget.view.NovaFrameLayout
