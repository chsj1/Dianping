...
@Deprecated
public class BaseTuanListFragment extends BaseTuanFragment
{
  ...
  View mListContainer;
  boolean mListShown;
  private final AdapterView.OnItemClickListener mOnClickListener = new BaseTuanListFragment.1(this);
  private final AdapterView.OnItemLongClickListener mOnLongClickListener = new BaseTuanListFragment.2(this);
  View mProgressContainer;
  private final Runnable mRequestFocus = new BaseTuanListFragment.3(this);
 ...
 * Qualified Name:     com.dianping.tuan.fragment.BaseTuanListFragment
