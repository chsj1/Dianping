...
import java.util.List<Lcom.alipay.mobilesecuritysdk.datainfo.LocationInfo;>;
import java.util.List<Lcom.alipay.mobilesecuritysdk.datainfo.WifiCollectInfo;>;
...
public class CollectedInfo
{
  ...
  private List<WifiCollectInfo> GetWifiInfos(Context paramContext)
  {
    ...
    return (List<WifiCollectInfo>)(List<WifiCollectInfo>)null;
  }
