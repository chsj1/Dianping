...
public class DeviceIdManager
{
  ...
  private void Update(Context paramContext, Map<String, String> paramMap)
  {
    monitorenter;
    try
    {
      new Thread(new Runnable(paramContext, paramMap)
      {
        public void run()
        {
          try
          {
            ...
            localDeviceIdModel.Init(this.val$context, this.val$args);
            localDeviceIdModel.UpdateId(this.val$context, DeviceIdManager.strMap);
            return;
          }
          catch (Throwable localThrowable)
          {
            ...
            if ((this.val$args.get("tid") != null) && (((String)this.val$args.get("tid")).length() > 20))
              localArrayList.add(((String)this.val$args.get("tid")).substring(0, 20));
            if ((this.val$args.get("utdid") != null) && (((String)this.val$args.get("utdid")).length() > 20))
              localArrayList.add(((String)this.val$args.get("utdid")).substring(0, 20));
