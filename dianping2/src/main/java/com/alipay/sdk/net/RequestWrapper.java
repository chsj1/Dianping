...
public class RequestWrapper
{
    ...
    throws NetErrorException, FailOperatingException, AppErrorException, UnZipException
  {
    ...
    while (true)
    {
      try
      {
        localObject = FrameUtils.a(localObject);
        if (!TextUtils.equals(MD5.a(localObject), paramContext.optString("md5")))
          continue;
        paramContext.put("form", new JSONObject(new String(localObject, "utf-8")));
      ...
      catch (java.io.UnsupportedEncodingException paramContext)
      {
    ...
    return (FrameData)FrameFactoryManager.a(paramRequest);
  }
}
