...
public class MspClient
{
  ...
  private HttpHost c()
  {
    ...
    while (localObject == null);
    return (HttpHost)new HttpHost((String)localObject, i);
  }
  ...
  private HttpHost d()
  {
    ...
    return (HttpHost)(HttpHost)localObject1;
  }
  ...
  private HttpHost e()
  {
    ...
    while (TextUtils.isEmpty((CharSequence)localObject));
    return (HttpHost)new HttpHost((String)localObject, Integer.parseInt(str));
  }
    ...
    throws NetErrorException
  {
    ...
    while (true)
    {
      ...
      catch (org.apache.http.conn.ConnectTimeoutException paramString)
      {
        if (localMspHttpClient == null)
          continue;
      ...
      catch (java.net.SocketException paramString)
      {
        throw new NetErrorException();
      ...
      catch (java.net.SocketTimeoutException paramString)
      {
        if (localMspHttpClient == null)
          continue;
        localMspHttpClient.b();
