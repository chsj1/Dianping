...
public class H5PayActivity extends Activity
{
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    while (true)
    {
      ...
      this.a.setWebViewClient(new MyWebViewClient(0));
      this.a.setWebChromeClient(new MyWebChromeClient(0));
      ...
      try
      {
        ...
        try
        {
          label341: paramBundle = this.a.getClass().getMethod("removeJavascriptInterface", new Class[0]);
          if (paramBundle == null)
            continue;
