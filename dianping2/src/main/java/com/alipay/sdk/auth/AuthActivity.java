...
public class AuthActivity extends Activity
{
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    while (true)
    {
      ...
      this.c.setWebViewClient(new MyWebViewClient(0));
      this.c.setWebChromeClient(new MyWebChromeClient(0));
      ...
      try
      {
        ...
        try
        {
          label314: paramBundle = this.c.getClass().getMethod("removeJavascriptInterface", new Class[0]);
          if (paramBundle == null)
            continue;
