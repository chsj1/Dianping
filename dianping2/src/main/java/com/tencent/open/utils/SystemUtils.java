...
public class SystemUtils
{
  ...
  public static String getAppSignatureMD5(Context paramContext, String paramString)
  {
    ...
    //   0: ldc 132
    //   2: ldc 134
    //   4: invokestatic 140	com/tencent/a/a/c:a	(Ljava/lang/String;Ljava/lang/String;)V
    //   7: aload_0
    //   8: invokevirtual 143	android/content/Context:getPackageName	()Ljava/lang/String;
    //   11: astore_3
    //   12: aload_0
    ...
    //   22: getfield 147	android/content/pm/PackageInfo:signatures	[Landroid/content/pm/Signature;
    //   25: astore_0
    //   26: ldc 149
    //   28: invokestatic 155	java/security/MessageDigest:getInstance	(Ljava/lang/String;)Ljava/security/MessageDigest;
    //   31: astore_2
    //   32: aload_2
    //   33: aload_0
    //   34: iconst_0
    //   35: aaload
    //   36: invokevirtual 161	android/content/pm/Signature:toByteArray	()[B
    //   39: invokevirtual 165	java/security/MessageDigest:update	([B)V
    //   42: aload_2
    //   43: invokevirtual 168	java/security/MessageDigest:digest	()[B
    //   46: invokestatic 174	com/tencent/open/utils/Util:toHexString	([B)Ljava/lang/String;
    //   49: astore_0
    //   50: aload_2
    //   51: invokevirtual 177	java/security/MessageDigest:reset	()V
    //   54: aload_2
    //   55: new 179	java/lang/StringBuilder
    //   58: dup
    //   59: invokespecial 180	java/lang/StringBuilder:<init>	()V
    //   62: aload_3
    ...
    //   92: invokevirtual 192	java/lang/String:getBytes	()[B
    //   95: invokevirtual 165	java/security/MessageDigest:update	([B)V
    //   98: aload_2
    //   99: invokevirtual 168	java/security/MessageDigest:digest	()[B
    //   102: invokestatic 174	com/tencent/open/utils/Util:toHexString	([B)Ljava/lang/String;
    //   105: astore_0
    //   106: aload_2
    //   107: invokevirtual 177	java/security/MessageDigest:reset	()V
    //   110: aload_0
    //   111: areturn
    //   112: astore_1
    //   113: ldc 188
    ...
    //   122: ldc 194
    //   124: aload_1
    //   125: invokestatic 197	com/tencent/a/a/c:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   128: aload_0
    //   129: areturn
    //   130: astore_1
    //   131: goto -15 -> 116
