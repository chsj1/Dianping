...
public class PKDialog extends c
  implements com.tencent.open.b.a.a
{
  ...
  private void createViews()
  {
    ...
    try
    {
      ...
      localObject = this.mWebView.getSettings().getClass();
    }
    catch (Exception localException2)
    {
      try
      {
        Object localObject = ((Class)localObject).getMethod("removeJavascriptInterface", new Class[] { String.class });
        if (localObject != null)
          ((Method)localObject).invoke(this.mWebView, new Object[] { "searchBoxJavaBridge_" });
        label191: localObject = new RelativeLayout.LayoutParams(-1, this.mWebviewHeight);
    ...
    implements IUiListener
  {
    ...
    public void onComplete(Object paramObject)
    {
      ...
      b.a().a((Context)this.mWeakCtx.get(), this.mAction + "_H5", SystemClock.elapsedRealtime(), 0L, 0L, paramObject.optInt("ret", -6), this.mAppid, this.mUrl, "1000067");
      if (this.mWeakL != null)
      {
