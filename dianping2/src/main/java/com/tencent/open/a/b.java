...
public class b
{
  ...
  private void a(Context paramContext, String paramString)
  {
    ...
    localBundle.putString("releaseversion", "OpenSdk_2.4.lite");
    localBundle.putString("device", Build.DEVICE);
    localBundle.putString("qua", "V1_AND_OpenSDK_2.4.lite_1077_RDM_B");
    ...
    while (i < this.g.size())
    {
      ...
      paramString = d.b(paramContext) + ((a)this.g.get(i)).i();
    ...
    {
      int j = i - this.g.size();
      localBundle.putString(i + "_1", ((a)this.h.get(j)).a());
      localBundle.putString(i + "_2", ((a)this.h.get(j)).b());
      localBundle.putString(i + "_3", ((a)this.h.get(j)).c());
      localBundle.putString(i + "_4", ((a)this.h.get(j)).d());
      localBundle.putString(i + "_5", ((a)this.h.get(j)).e());
      localBundle.putString(i + "_6", ((a)this.h.get(j)).f());
      localBundle.putString(i + "_7", ((a)this.h.get(j)).g());
      localBundle.putString(i + "_8", ((a)this.h.get(j)).h());
      paramString = d.b(paramContext) + ((a)this.h.get(j)).i();
      localBundle.putString(i + "_9", paramString);
      i += 1;
    }
  ...
  private void a(Context paramContext, String paramString1, String paramString2, Bundle paramBundle)
  {
    new Thread(paramString1, paramContext, paramBundle)
    {
      ...
      public void run()
      {
        ...
        //   36: aconst_null
        //   37: invokestatic 64	com/tencent/open/utils/OpenConfig:getInstance	(Landroid/content/Context;Ljava/lang/String;)Lcom/tencent/open/utils/OpenConfig;
        //   40: ldc 66
        //   42: invokevirtual 70	com/tencent/open/utils/OpenConfig:getInt	(Ljava/lang/String;)I
        //   45: invokestatic 73	com/tencent/open/a/b:a	(Lcom/tencent/open/a/b;I)I
        //   48: pop
        //   49: aload_0
        ...
        //   58: invokestatic 76	com/tencent/open/a/b:a	(Lcom/tencent/open/a/b;)I
        //   61: ifne +192 -> 253
        //   64: iconst_3
        //   65: istore_3
        //   66: aload_1
        //   67: iload_3
        //   68: invokestatic 73	com/tencent/open/a/b:a	(Lcom/tencent/open/a/b;I)I
        //   71: pop
        //   72: iconst_0
        //   73: istore_3
        //   74: iconst_0
        ...
        //   118: invokestatic 87	com/tencent/open/utils/HttpUtils:getHttpClient	(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Lorg/apache/http/client/HttpClient;
        //   121: astore_1
        //   122: new 89	org/apache/http/client/methods/HttpPost
        //   125: dup
        //   126: aload_0
        //   127: getfield 22	com/tencent/open/a/b$1:a	Ljava/lang/String;
        ...
        //   154: dup
        //   155: aload_0
        //   156: getfield 26	com/tencent/open/a/b$1:c	Landroid/os/Bundle;
        //   159: invokestatic 115	com/tencent/open/utils/Util:encodeUrl	(Landroid/os/Bundle;)Ljava/lang/String;
        ...
        //   201: pop
        //   202: aload_0
        //   203: getfield 20	com/tencent/open/a/b$1:d	Lcom/tencent/open/a/b;
        //   206: iconst_0
        //   207: invokestatic 154	com/tencent/open/a/b:a	(Lcom/tencent/open/a/b;Z)Z
        //   210: pop
        //   211: ldc 39
        ...
        //   225: aload_0
        //   226: getfield 22	com/tencent/open/a/b$1:a	Ljava/lang/String;
        ...
        //   252: return
        //   253: aload_0
        //   254: getfield 20	com/tencent/open/a/b$1:d	Lcom/tencent/open/a/b;
        //   257: invokestatic 76	com/tencent/open/a/b:a	(Lcom/tencent/open/a/b;)I
        //   260: istore_3
        //   261: goto -195 -> 66
        //   264: ldc 39
        //   266: ldc 160
        ...
        //   300: iload 6
        //   302: aload_0
        //   303: getfield 20	com/tencent/open/a/b$1:d	Lcom/tencent/open/a/b;
        //   306: invokestatic 76	com/tencent/open/a/b:a	(Lcom/tencent/open/a/b;)I
        ...
        //   357: invokestatic 174	com/tencent/open/a/b:c	(Lcom/tencent/open/a/b;)Lcom/tencent/open/a/c;
        //   360: aload_0
        //   361: getfield 20	com/tencent/open/a/b$1:d	Lcom/tencent/open/a/b;
        //   364: invokestatic 177	com/tencent/open/a/b:b	(Lcom/tencent/open/a/b;)Ljava/util/ArrayList;
        //   367: invokevirtual 182	com/tencent/open/a/c:a	(Ljava/util/ArrayList;)I
        //   370: pop
        //   371: return
        //   372: astore_1
        //   373: iconst_1
  ...
  public void a(Context paramContext, String paramString1, long paramLong1, long paramLong2, long paramLong3, int paramInt, String paramString2, String paramString3, String paramString4)
  {
    ...
    if (paramString4 == null)
      str = "1000067";
    if (this.f == null)
      this.f = new c(paramContext.getApplicationContext());
