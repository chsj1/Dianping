...
public class Constants
{
  ...
  public static final String SDK_QUA = "V1_AND_OpenSDK_2.4.lite_1077_RDM_B";
  private static final String SDK_VER = "2.4";
  public static final String SDK_VERSION = "2.4.lite";
  public static final String SDK_VERSION_REPORT = "OpenSdk_2.4.lite";
  public static final String SDK_VERSION_STRING = "Android_SDK_2.4.lite";
