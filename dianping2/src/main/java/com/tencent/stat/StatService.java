...
public class StatService
{
    ...
    for (int m = 1; ; m = 0)
    {
      ...
      while (true)
      {
        ...
        while (true)
        {
          ...
          return e;
          label154: i.e("Exceed StatConfig.getMaxDaySessionNumbers().");
        }
      }
    }
  }
  ...
  public static void trackCustomBeginEvent(Context paramContext, String paramString, String[] paramArrayOfString)
  {
    ...
    try
    {
      paramString = new c(paramString, paramArrayOfString, null);
  ...
  public static void trackCustomEndEvent(Context paramContext, String paramString, String[] paramArrayOfString)
  {
    ...
    while (true)
    {
      try
      {
        ...
        paramString.a(paramArrayOfString);
        paramArrayOfString = Long.valueOf((System.currentTimeMillis() - localLong.longValue()) / 1000L);
        if (paramArrayOfString.longValue() == 0L)
        {
          l = 1L;
      ...
      long l = paramArrayOfString.longValue();
    }
    label175: i.error("No start time found for custom event: " + localc.toString() + ", lost trackCustomBeginEvent()?");
  }
  ...
  public static void trackCustomEndKVEvent(Context paramContext, String paramString, Properties paramProperties)
  {
    ...
    label175: i.error("No start time found for custom event: " + localc.toString() + ", lost trackCustomBeginKVEvent()?");
  }
