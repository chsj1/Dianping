...
public final class AnimatorSet extends Animator
{
  ...
  public AnimatorSet clone()
  {
    ...
    return (AnimatorSet)(AnimatorSet)(AnimatorSet)(AnimatorSet)localAnimatorSet;
  }
  ...
  public void start()
  {
    ...
    this.mDelayAnim.addListener(new AnimatorListenerAdapter((ArrayList)localObject1)
    {
      ...
      public void onAnimationEnd(Animator paramAnimator)
      {
        if (!this.canceled)
        {
          ...
          while (i < j)
          {
            ...
            AnimatorSet.this.mPlayingSet.add(paramAnimator.animation);
            i += 1;
          }
        }
      }
    ...
    public void onAnimationEnd(Animator paramAnimator)
    {
      ...
      if (!AnimatorSet.this.mTerminated)
      {
        ...
        while (true)
        {
          ...
          i += 1;
          continue;
          label160: AnimatorSet.access$302(this.mAnimatorSet, false);
        }
      }
    }
