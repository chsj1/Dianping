...
public class AnimatorInflater
{
    ...
    throws XmlPullParserException, IOException
  {
    ...
    while (true)
    {
      ...
      label142: if (((String)localObject1).equals("set"))
      {
    ...
    return (Animator)(Animator)(Animator)localObject3;
  }
    ...
    throws Resources.NotFoundException
  {
    ...
    if (i == 0)
    {
      ...
      label222: paramAttributeSet.setFloatValues(new float[] { f1, f2 });
    }
    label328: label334: label340: label346: label352: label363: label376: 
    do
      while (true)
      {
    ...
    while (k == 0);
    label390: label431: label452: label587: if (n == 5)
      i = (int)localTypedArray.getDimension(6, 0.0F);
    while (true)
    {
      label532: label572: paramAttributeSet.setIntValues(new int[] { i });
      break;
      if ((n >= 28) && (n <= 31))
      {
