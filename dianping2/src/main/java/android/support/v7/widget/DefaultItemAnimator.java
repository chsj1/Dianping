  ...
  public void runPendingAnimations()
  {
    ...
    if (!this.mPendingRemovals.isEmpty())
    {
      ...
      if (this.mPendingChanges.isEmpty())
        break label82;
      k = 1;
      label38: if (this.mPendingAdditions.isEmpty())
        break label88;
    }
    label76: label82: label88: for (int m = 1; ; m = 0)
    {
      if ((i != 0) || (j != 0) || (m != 0) || (k != 0))
        break label94;
      return;
    ...
    label94: Object localObject1 = this.mPendingRemovals.iterator();
    ...
    while (true)
    {
      ...
      break label208;
      label415: ((Runnable)localObject2).run();
      break label282;
      label422: break;
      label424: l1 = 0L;
      break label354;
