...
public class SlidingPaneLayout extends ViewGroup
{
  ...
  private void onPanelDragged(int paramInt)
  {
    ...
    label140: label148: for (int j = localLayoutParams.rightMargin; ; j = localLayoutParams.leftMargin)
    {
  ...
  public void draw(Canvas paramCanvas)
  {
    ...
    label53: int k = localView.getTop();
  ...
  void updateObscuredViewsVisibility(View paramView)
  {
    ...
    while (true)
    {
      ...
      i = getPaddingLeft();
      break;
      label122: j = getWidth() - getPaddingRight();
      break label32;
      label136: k = 0;
      i1 = 0;
      n = 0;
    ...
    {
      i3 = j;
      label160: int i8 = Math.max(i3, localView.getLeft());
      int i9 = Math.max(i4, localView.getTop());
      if (!bool)
        break label267;
      i3 = i;
      label190: i3 = Math.min(i3, localView.getRight());
      int i10 = Math.min(i5 - i6, localView.getBottom());
      if ((i8 < m) || (i9 < i1) || (i3 > n) || (i10 > k))
        break label274;
    }
    label267: label274: for (int i3 = 4; ; i3 = 0)
    {
