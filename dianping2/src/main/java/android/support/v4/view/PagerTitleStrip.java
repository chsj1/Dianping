  ...
  implements ViewPager.Decor
{
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    int m = View.MeasureSpec.makeMeasureSpec(Math.max(0, (int)(paramInt1 * 0.8F)), -2147483648);
    int n = View.MeasureSpec.makeMeasureSpec(Math.min(0, paramInt2 - k), -2147483648);
  ...
  void updateText(int paramInt, PagerAdapter paramPagerAdapter)
  {
    ...
    label239: for (Object localObject = paramPagerAdapter.getPageTitle(paramInt); ; localObject = null)
    {
