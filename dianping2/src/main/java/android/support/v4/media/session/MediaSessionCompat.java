    ...
    implements MediaSessionCompat.MediaSessionImpl
  {
    ...
    private boolean update()
    {
      ...
      if (this.mIsActive)
      {
        ...
        label174: MediaSessionCompatApi14.setState(this.mRccObj, 0);
      ...
      while (true)
      {
        ...
        this.mIsRccRegistered = false;
        return false;
        label286: MediaSessionCompatApi8.unregisterMediaButtonEventReceiver(this.mContext, this.mComponentName);
      }
    }
    ...
    public void setCallback(MediaSessionCompat.Callback paramCallback, Handler paramHandler)
    {
      ...
      while (true)
      {
        ...
        if (paramHandler == null)
          new Handler();
        paramHandler = new MediaSessionCompatApi14.Callback(paramCallback)
        {
          public void onCommand(String paramString, Bundle paramBundle, ResultReceiver paramResultReceiver)
          {
    ...
    public void setMetadata(MediaMetadataCompat paramMediaMetadataCompat)
    {
      ...
      do
      {
        ...
        {
          paramMediaMetadataCompat = localObject1;
          if (this.mState != null)
            break label85;
          l = 0L;
        }
