  ...
  implements FragmentManager.BackStackEntry, Runnable
{
      ...
      if (this.mManager.mAdded != null)
      {
        ...
        if (i < this.mManager.mAdded.size())
        {
          ...
          for (localObject2 = null; ; localObject2 = localObject1)
          {
            ...
            break;
            label192: setFirstOut(paramSparseArray1, localFragment);
          }
        }
      }
  ...
  private boolean configureTransitions(int paramInt, TransitionState paramTransitionState, boolean paramBoolean, SparseArray<Fragment> paramSparseArray1, SparseArray<Fragment> paramSparseArray2)
  {
    ...
    label216: localObject1 = new ArrayList();
    ...
    if (localObject3 != null)
      if (!paramBoolean)
        break label470;
    label470: for (bool = ((Fragment)localObject3).getAllowReturnTransitionOverlap(); ; bool = ((Fragment)localObject3).getAllowEnterTransitionOverlap())
    {
  ...
  {
    paramView.getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener(paramView, paramObject, paramArrayList, paramTransitionState, paramBoolean, paramFragment1, paramFragment2)
    {
      public boolean onPreDraw()
      {
        this.val$sceneRoot.getViewTreeObserver().removeOnPreDrawListener(this);
  ...
  public TransitionState popFromBackStack(boolean paramBoolean, TransitionState paramTransitionState, SparseArray<Fragment> paramSparseArray1, SparseArray<Fragment> paramSparseArray2)
  {
    ...
    label98: bumpBackStackNesting(-1);
    int i;
    label111: int j;
    label119: int k;
    if (localTransitionState != null)
    {
      ...
      if (localTransitionState == null)
        break label266;
      k = 0;
      label136: if (localTransitionState == null)
        break label275;
    }
  ...
  public void run()
  {
    ...
    label224: label233: label242: for (int m = 0; ; m = localOp.exitAnim)
      switch (localOp.cmd)
      {
      default:
      ...
      if (this.mManager.mAdded != null)
      {
        ...
        if (n < this.mManager.mAdded.size())
        {
          ...
          while (true)
          {
            ...
            break;
            label423: if (localOp.removed == null)
    ...
    label698: this.mManager.moveToState(this.mManager.mCurState, j, i, true);
    if (this.mAddToBackStack)
