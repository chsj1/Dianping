...
import java.util.ArrayList<Landroid.support.v4.app.Fragment;>;
  ...
  implements LayoutInflaterFactory
{
  ...
  public void enqueueAction(Runnable paramRunnable, boolean paramBoolean)
  {
    ...
    //   1: ifne +7 -> 8
    //   4: aload_0
    //   5: invokespecial 570	android/support/v4/app/FragmentManagerImpl:checkStateLoss	()V
    //   8: aload_0
    //   9: monitorenter
    //   10: aload_0
    //   11: getfield 449	android/support/v4/app/FragmentManagerImpl:mDestroyed	Z
    //   14: ifne +10 -> 24
    //   17: aload_0
    //   18: getfield 281	android/support/v4/app/FragmentManagerImpl:mHost	Landroid/support/v4/app/FragmentHostCallback;
    //   21: ifnonnull +19 -> 40
    //   24: new 154	java/lang/IllegalStateException
    //   27: dup
    //   28: ldc_w 572
    //   31: invokespecial 159	java/lang/IllegalStateException:<init>	(Ljava/lang/String;)V
    //   34: athrow
    //   35: astore_1
    //   36: aload_0
    //   37: monitorexit
    ...
    //   39: athrow
    //   40: aload_0
    //   41: getfield 536	android/support/v4/app/FragmentManagerImpl:mPendingActions	Ljava/util/ArrayList;
    //   44: ifnonnull +14 -> 58
    //   47: aload_0
    //   48: new 307	java/util/ArrayList
    //   51: dup
    //   52: invokespecial 308	java/util/ArrayList:<init>	()V
    //   55: putfield 536	android/support/v4/app/FragmentManagerImpl:mPendingActions	Ljava/util/ArrayList;
    //   58: aload_0
    //   59: getfield 536	android/support/v4/app/FragmentManagerImpl:mPendingActions	Ljava/util/ArrayList;
    //   62: aload_1
    //   63: invokevirtual 312	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   66: pop
    //   67: aload_0
    //   68: getfield 536	android/support/v4/app/FragmentManagerImpl:mPendingActions	Ljava/util/ArrayList;
    //   71: invokevirtual 366	java/util/ArrayList:size	()I
    //   74: iconst_1
    //   75: if_icmpne +32 -> 107
    //   78: aload_0
    //   79: getfield 281	android/support/v4/app/FragmentManagerImpl:mHost	Landroid/support/v4/app/FragmentHostCallback;
    //   82: invokevirtual 576	android/support/v4/app/FragmentHostCallback:getHandler	()Landroid/os/Handler;
    //   85: aload_0
    //   86: getfield 149	android/support/v4/app/FragmentManagerImpl:mExecCommit	Ljava/lang/Runnable;
    //   89: invokevirtual 582	android/os/Handler:removeCallbacks	(Ljava/lang/Runnable;)V
    //   92: aload_0
    //   93: getfield 281	android/support/v4/app/FragmentManagerImpl:mHost	Landroid/support/v4/app/FragmentHostCallback;
    //   96: invokevirtual 576	android/support/v4/app/FragmentHostCallback:getHandler	()Landroid/os/Handler;
    //   99: aload_0
    //   100: getfield 149	android/support/v4/app/FragmentManagerImpl:mExecCommit	Ljava/lang/Runnable;
    //   103: invokevirtual 586	android/os/Handler:post	(Ljava/lang/Runnable;)Z
    //   106: pop
    //   107: aload_0
    //   108: monitorexit
    //   109: return
  ...
  void moveToState(Fragment paramFragment, int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean)
  {
    ...
    while (true)
    {
      ...
      i = j;
      label546: label578: Object localObject2;
      ...
      while (true)
      {
        ...
        break label546;
        label1044: paramFragment.mInnerView = null;
        i = j;
        break label578;
        label1056: paramFragment.mView = NoSaveStateFrameLayout.wrap(paramFragment.mView);
        break label803;
        label1070: paramFragment.mInnerView = null;
      }
      i = paramInt1;
      if (paramFragment.mState <= paramInt1)
        continue;
        ...
        while (true)
        {
          ...
          if ((paramFragment.mView != null) && (paramFragment.mContainer != null))
          {
            ...
            if (localObject1 != null)
            {
              ...
              paramFragment.mStateAfterAnimating = paramInt1;
              ((Animation)localObject1).setAnimationListener(new AnimateOnHWLayerIfNeededListener(paramFragment.mView, (Animation)localObject1, paramFragment)
              {
  ...
  public View onCreateView(View paramView, String paramString, Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    while (true)
    {
      ...
      paramView = paramString;
      break label354;
      label553: moveToState(paramView);
    }
    label561: if (k != 0)
      ...
      if (paramList != null)
      {
        ...
        if (i < paramList.size())
        {
          ...
          for (((Fragment)localObject1).mTarget = ((Fragment)this.mActive.get(((Fragment)localObject1).mTargetIndex)); ; ((Fragment)localObject1).mTarget = null)
          {
            i += 1;
            break;
            label470: Log.w("FragmentManager", "Re-attaching retained fragment " + localObject1 + " target no longer exists: " + ((Fragment)localObject1).mTargetIndex);
          }
        }
      }
  ...
  ArrayList<Fragment> retainNonConfig()
  {
    ...
    if (this.mActive != null)
    {
      ...
      if (i < this.mActive.size())
      {
        ...
        label159: for (int j = localFragment.mTarget.mIndex; ; j = -1)
        {
    ...
    while (true)
    {
      ...
      if (i < m)
      {
        ...
        while (true)
        {
          ...
          i += 1;
          break;
          label348: ((FragmentState)localObject2).mSavedFragmentState = ((Fragment)localObject1).mSavedFragmentState;
        }
      }
      if (j != 0)
        break;
